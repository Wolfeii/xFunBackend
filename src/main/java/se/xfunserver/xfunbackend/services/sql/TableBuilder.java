...
public class TableBuilder {
    ...
    public TableBuilder(String tableName, DatabaseManager databaseManager){
        ...
        this.query = "CREATE TABLE IF NOT EXISTS xfun_" + tableName + " (";
    }
                ...
                if (!
                        this.databaseManager.getResults(null,
                                ...
                                new HashMap<Integer, Object>(){{
                                    put(1, name);
                                    put(2, "xfun_" + tableName);
                                    put(3, SQLService.DATABASE_NAME);
                                }}
                        ).next()) {
                    query_update += "ALTER TABLE xfun_" + this.tableName + " ADD " + specs + ";";
                }

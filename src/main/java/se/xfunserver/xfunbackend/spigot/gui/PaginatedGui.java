...
public abstract class PaginatedGui extends Gui {
     ...
     *
     * @param user the viewer that has the menu open
     * @param page        the page to start at
     */
    public final void setPage(xFunUser user, int page) {
    ...
    private void transitionToPage(MenuInventoryHolder holder, int page) {
        ...
        xFunUser viewer = holder.getViewer();
    ...
    public abstract static class Paginator {
         ...
         */
        public abstract void getItemsFor(xFunUser viewer, int page,

...
public class UtilTime {
    ...
    public static String format(double seconds) {
        ...
        if (minutes < 1)
            return UtilMath.trim(seconds, 0) + " Sekunder";
        else if (hours < 1)
            return UtilMath.trim(minutes, 0) + " Minuter";
        else if (days < 1)
            return UtilMath.trim(hours, 0) + " Timmar";
        else if (months < 1)
            return UtilMath.trim(days, 0) + " Dagar";
        else if (years < 1)
            return UtilMath.trim(months, 0) + " Månader";
        else
           return UtilMath.trim(years, 0) + " År";
    }
